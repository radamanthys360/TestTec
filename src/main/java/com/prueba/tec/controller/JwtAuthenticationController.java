...
import com.prueba.tec.conf.JwtTokenUtil;
import com.prueba.tec.request.JwtRequest;
import com.prueba.tec.response.JwtResponse;
...
public class JwtAuthenticationController {
	...
	private void authenticate(String username, String password) throws Exception {
		...
		try {
			...
			throw new Exception("Usuario invalido ", e);
